...
/**
 * ============================================================
 * ENTIDAD: DetalleVenta  â†’  tabla DETALLE_VENTA en SQL Server
 * ============================================================
 * Representa UN producto dentro de una venta.
 * Si una venta tiene 3 productos â†’ 3 filas en esta tabla.
 *
 ...
 * 2. AquÃ­:  @Column(name = "descuento", precision = 5, scale = 2)
...
public class DetalleVenta {
    ...
    // FK hacia la venta padre (NO se expone en el JSON de salida para evitar recursiÃ³n)
    @ManyToOne
    ...
    // insertable = false â†’ JPA no la incluye en el INSERT
    // updatable  = false â†’ JPA no la incluye en el UPDATE
